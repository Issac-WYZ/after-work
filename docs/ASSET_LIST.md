...
| Player base walk | character animation | Shared / Player | 24x32 px, 4 directions, 3 or 4 frames | placeholder | `scenes/shared/Player.tscn` | original placeholder | N/A | 是 | 当前为 Polygon2D，0.1.5 最高优先级替换。 |
...
| 资源名称 | 类型 | 所属场景 | 推荐尺寸 | 当前状态 | 文件路径 | 来源 | 许可证 | 是否已导入 | 备注 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Player base sprite sheet | character animation | Shared / Player | 24x32 px, 4 directions, 3 or 4 frames | placeholder | TBD: `assets/art/characters/player_base_sprite_sheet.png` | TBD | TBD | 否 | 第一优先级，命名需覆盖 `player_idle_down` 和 4 方向行走。 |
